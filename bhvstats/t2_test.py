"""
This module contains implementations of various two sample Hotelling's 
t-squared-tests.
"""
...
def paired_t2_test(
    first_sample: ndarray, second_sample: ndarray, test_dist="f"
) -> float:
    """
...
def twosamplet2test_equal(
    ...
    if test_dist == "f":
        statistic = (
            t_squared * (size_1 + size_2 - dim - 1) / (dim * (size_1 + size_2 - 2))
        )
